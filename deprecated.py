...
twitch_miner = TwitchChannelPointsMiner(
    ...
    streamer_settings=StreamerSettings(
        ...
        bet=BetSettings(
            ...
            # ── Неуверенные ставки ─────────────────────────────────────────
            uncertain_percentage=2,     # 2% от баланса (маленькая ставка)
            uncertain_odds_min=45.0,    # odds 45–55% считаются "неуверенными"
            uncertain_odds_max=55.0,
            uncertain_max_points=5000,  # не более 5000 за раз
            # ──────────────────────────────────────────────────────────────
        )
    )
)
